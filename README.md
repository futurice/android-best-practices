...
Therefore, try to keep your views hierarchy as flat as possible: learn how to use [RelativeLayout](https://developer.android.com/guide/topics/ui/layout/relative.html), how to [optimize your layouts](http://developer.android.com/training/improving-layouts/optimizing-layout.html) and to use the [`<merge>` tag](http://stackoverflow.com/questions/8834898/what-is-the-purpose-of-androids-merge-tag-in-xml-layouts). If you want to debug the hierachy view of a physical device use [ViewServer](https://github.com/romainguy/ViewServer) or alteratively use it with an emulator or a Virtual Device (e.g. [Android-x86](http://www.android-x86.org)).
